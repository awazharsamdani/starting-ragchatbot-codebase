...
from models import create_course, create_lesson, create_course_chunk
...
def chunk_text(text: str, chunk_size: int, chunk_overlap: int) -> List[str]:
    ...
    while i < len(sentences):
        ...
        for j in range(i, len(sentences)):
            ...
            if current_size + total_addition > chunk_size and current_chunk:
                break
        ...
        if current_chunk:
            ...
            if chunk_overlap > 0:
                ...
                for k in range(len(current_chunk) - 1, -1, -1):
                    ...
                    if overlap_size + sentence_len <= chunk_overlap:
...
def process_course_document(file_path: str, chunk_size: int, chunk_overlap: int) -> Tuple[dict, List[dict]]:
    """
    ...
    Returns:
        Tuple of (course dict, list of course chunk dicts)
    """
        ...
        if lesson_match:
            ...
            if current_lesson is not None and lesson_content:
                ...
                if lesson_text:
                    ...
                    chunks = chunk_text(lesson_text, chunk_size, chunk_overlap)
                    for idx, chunk in enumerate(chunks):
                        ...
                        course_chunk = create_course_chunk(
    ...
    if not course_chunks and len(lines) > 2:
        ...
        if remaining_content:
            chunks = chunk_text(remaining_content, chunk_size, chunk_overlap)
            for chunk in chunks:
                course_chunk = create_course_chunk(
                    content=chunk,
                    course_title=course["title"],
